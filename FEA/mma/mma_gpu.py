...
This simply maps the imports to GPU packages.
...
from cupyx.scipy.sparse import diags # or use numpy: from numpy import diag as diags
from cupy.linalg import solve # or use numpy: from numpy.linalg import solve
